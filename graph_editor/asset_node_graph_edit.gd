...
func paste_from_external() -> void:
    ...
    var an_roots: Array[HyAssetNode] = CHANE_AssetNodeEditor.get_an_roots_within_set_no_aux(copied_external_ans)
...
func _add_pasted_nodes(ges: Array[GraphElement], asset_node_set: Array[HyAssetNode], make_duplicates: bool) -> Array[GraphElement]:
    ...
    if not make_duplicates:
        ...
        var pasted_an_roots: Array[HyAssetNode] = CHANE_AssetNodeEditor.get_an_roots_within_set_no_aux(asset_node_set)
